...
fn test_harvest_end_valid() {
    ...
    dust_harvest_dispatcher.end_dust_harvest(asteroid_cluster_id);
...
fn test_harvest_end_less_dust_now() {
    ...
    set_contract_address(dust_harvest_dispatcher.contract_address);
    set_account_contract_address(dust_harvest_dispatcher.contract_address);
...
fn test_harvest_end_not_owner() {
    let (world, asteroid_cluster_id, _, sender_owner, non_owner, dust_harvest_dispatcher) = setup();
