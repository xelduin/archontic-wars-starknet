...
// Type definition for `dojo_starter::systems::formations::formations::Formed` struct
export interface Formed {
  player: BigInt;
  direction: Position;
}
export const FormedDefinition = {
  player: RecsType.BigInt,
  direction: PositionDefinition,
};
...
export function defineContractComponents(world: World) {
  return {
    ...
    // Model definition for `dojo_starter::systems::formations::formations::Formed` model
    Formed: (() => {
      return defineComponent(
        world,
        {
